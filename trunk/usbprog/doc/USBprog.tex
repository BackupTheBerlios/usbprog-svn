...
seconds and the programming dialog shown in figure \vref{fig:avrstudio_programming} appears. appear.
...
\begin{thebibliography}{99}
  ...
  \bibitem{WinavrManual} ``WinAVR User's Manual'' \url{http://winavr.sourceforge.net/WinAVR-user-manual.html}
